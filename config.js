...
module.exports = {
    ...
    OWNER_NAME: process.env.OWNER_NAME || "𝕵𝖚𝖓𝖎𝖔𝖗_𝕯𝖆𝖗𝖐",
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50940778063",
    BOT: process.env.BOT_NAME || '𝕯𝖆𝖗𝖐𝕭𝖔𝖞-MD',
    ...
    get GOODBYE_MESSAGE() { return hybridConfig.getSetting('GOODBYE_MESSAGE', 'yes'); },
    get ANTICALL() { return hybridConfig.getSetting('AUTO_REJECT_CALL', 'no'); },
    get WELCOME_MESSAGE() { return hybridConfig.getSetting('WELCOME_MESSAGE', 'yes'); },
    ...
    get STATUS_REACT_EMOJIS() { return process.env.STATUS_REACT_EMOJIS || "yes"; },
